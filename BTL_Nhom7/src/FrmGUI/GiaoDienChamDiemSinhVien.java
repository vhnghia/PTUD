...
public class GiaoDienChamDiemSinhVien extends JFrame implements ActionListener{
	...
	private JMenuItem menuIQLSV , menuIDangXuat, menuIThoat, menuIQLGV, menuIThongKe, menuIThemHoiDong, menuITrangChu;
	...
	public void GiaoDienChamDiem() {
		...
		menuITrangChu = new JMenuItem("Trang chủ");
		...
		menuITrangChu.addActionListener(this);
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource().equals(menuITrangChu)) {
		...
		if(e.getSource().equals(btnLuuDiem)) {
			...
			if(KiemTraSo()) {
				if(KiemTraSoAm()) {
					...
					JOptionPane.showMessageDialog(null, "Vui Long Nhap So > 0 va diem < 10");
			}else
