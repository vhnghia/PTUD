...
public class GiaoDienQuanLiDiemSinhVien extends JFrame implements ActionListener{
	...
	private JMenuItem menuIQLSV , menuIDangXuat, menuIThoat, menuIQLGV, menuIThongKe, menuIThemHoiDong,MenuIDiem,menuHome;
	...
	public void Show() {
		...
		String [] masv = new String [listLV.size()];
		for(int i=0; i<listLV.size(); i++)
			masv[i] = listLV.get(i).getSinhVien().getMssv();
		...
		String [] Header = {"MSSV","Tên sinh viên","Khoa","Tên luận văn","Giảng viên hướng dẫn","Điểm TD1","Điểm TD2","Điểm TD3","Điểm TD4","Điểm TD5","Điểm PB1","Điểm PB2","Điểm PB3","Điểm PB4","Điểm PB5"};
		...
		for(int i = 0; i<listLV.size(); i++)
		{
			...
			dvtd = dvDAO.getDiemVongThamDinh(listLV.get(i).getSinhVien().getMssv(), "TD");
		...
		for(int i = 0; i<listLV.size(); i++) {
			...
			dvpb = dvDAO.getDiemVongThamDinh(listLV.get(i).getSinhVien().getMssv(), "PB");
				...
				if(KiemTraSo()==true) {
					if(KiemTraSoAm()==true) {
						...
						}else
						{
								...
								jtTableDiemSinhVien.setValueAt(pb1+"", dongDaChon, 10);
								jtTableDiemSinhVien.setValueAt(pb2+"", dongDaChon, 11);
								jtTableDiemSinhVien.setValueAt(pb3+"", dongDaChon, 12);
								jtTableDiemSinhVien.setValueAt(pb4+"", dongDaChon, 13);
								jtTableDiemSinhVien.setValueAt(pb5+"", dongDaChon, 14);
	...
	public void LoadLuanVan() {
		for(int i = 0; i<listLV.size(); i++)
			LoadLuanVanVaoBang(listLV.get(i),listDiemVongTD.get(i),listDiemVongPB.get(i));
	}

	public void LoadLuanVanVaoBang(LuanVan lv,DiemVong dv,DiemVong dv1) {
		...
		if(dv.getDiem().get(0)==0) {
			...
			if(dv1.getDiem().get(0)==0) {
				String row[] = {
						lv.getSinhVien().getMssv(),
						lv.getSinhVien().getHoten(),
						lv.getSinhVien().getKhoaSV().getTenKhoa(),
						lv.getTenLuanVan(),
	...
	public void fillForm(int row) {
		...
		jtTenLuanVan.setText(jtTableDiemSinhVien.getValueAt(row, 3)+"");
		jtDiemTD1.setText(jtTableDiemSinhVien.getValueAt(row, 5)+"");
		jtDiemTD2.setText(jtTableDiemSinhVien.getValueAt(row, 6)+"");
		jtDiemTD3.setText(jtTableDiemSinhVien.getValueAt(row, 7)+"");
		jtDiemTD4.setText(jtTableDiemSinhVien.getValueAt(row, 8)+"");
		jtDiemTD5.setText(jtTableDiemSinhVien.getValueAt(row, 9)+"");
		jtDiemPB1.setText(jtTableDiemSinhVien.getValueAt(row, 10)+"");
		jtDiemPB2.setText(jtTableDiemSinhVien.getValueAt(row, 11)+"");
		jtDiemPB3.setText(jtTableDiemSinhVien.getValueAt(row, 12)+"");
		jtDiemPB4.setText(jtTableDiemSinhVien.getValueAt(row, 13)+"");
		jtDiemPB5.setText(jtTableDiemSinhVien.getValueAt(row, 14)+"");
	}
